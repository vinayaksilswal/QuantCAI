...
import { ArrowRight, Zap, Cloud, Users, Atom, Cpu, Rocket, Settings } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button variant="outline" className="border-2 border-blue-400 text-blue-200 hover:bg-blue-500/20 hover:text-white px-8 py-4 text-lg rounded-lg transform hover:scale-105 transition-all duration-300 flex items-center gap-2 backdrop-blur-sm bg-white/5 shadow-xl">
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-blue-400/40 shadow-2xl shadow-blue-500/30">
              <h3 className="text-2xl font-bold text-white mb-4 drop-shadow-md">Interactive Quantum States</h3>
                ...
                <div className="bg-gradient-to-br from-blue-500/30 to-purple-500/30 p-6 rounded-xl border border-blue-400/40 backdrop-blur-sm shadow-xl">
                  <div className="flex items-center justify-center h-32 relative">
                    <div className="relative">
                      ...
                      <div className="absolute -top-2 -right-2 w-4 h-4 bg-yellow-400 rounded-full animate-ping shadow-lg"></div>
                      <div className="absolute -bottom-2 -left-2 w-3 h-3 bg-green-400 rounded-full animate-bounce shadow-md"></div>
                      <div className="absolute top-0 left-0 w-2 h-2 bg-purple-400 rounded-full animate-pulse shadow-sm"></div>
                    </div>
                  </div>
                  <div className="text-center mt-4">
                    <p className="text-white font-semibold text-xl drop-shadow-md">|ψ⟩ = α|0⟩ + β|1⟩</p>
                    <p className="text-blue-200 text-sm mt-2 drop-shadow-sm">Quantum Superposition State</p>
                  </div>
                </div>
              </div>
